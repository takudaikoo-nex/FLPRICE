...
exports.COMPANY_INFO = exports.ITEMS = exports.PLANS = void 0;
// --- Plan ID groups ---
var CREMATION = ['plan_01', 'plan_07', 'plan_02'];
var FUNERAL = ['plan_06', 'plan_03', 'plan_04', 'plan_05'];
var ALL = __spreadArray(__spreadArray([], CREMATION, true), FUNERAL, true);
var FUNERAL_FULL = ['plan_04', 'plan_05']; // 一日葬・二日葬（受付セット・会葬礼状・案内看板・返礼品・香典返し・料理）
// --- Plans (税抜) ---
exports.PLANS = [
...
exports.ITEMS = [
    ...
    },
    {
        ...
        allowedPlans: __spreadArray(['plan_07', 'plan_02'], FUNERAL, true),
        includedInPlans: __spreadArray(['plan_07', 'plan_02'], FUNERAL, true),
    },
    {
        id: 3, name: 'ご安置', type: 'checkbox',
        description: '弊社にてお預かり安置室利用料が含まれます。',
        allowedPlans: ALL, includedInPlans: __spreadArray(['plan_02'], FUNERAL, true),
    ...
    },
    {
        ...
        allowedPlans: ALL,
        includedInPlans: __spreadArray(['plan_02'], FUNERAL, true),
        // plan_01は△(optional)
    },
    {
    ...
    },
    {
        ...
        allowedPlans: __spreadArray(['plan_02'], FUNERAL, true),
        includedInPlans: [],
        options: [
